<p class="button"><a href="<?php echo get_url('plugin/assets/settings'); ?>"><img src="/wolf/plugins/assets/images/pencil.png" align="middle" alt="page icon" /> <?php echo __('Settings'); ?></a></p>
<!--
